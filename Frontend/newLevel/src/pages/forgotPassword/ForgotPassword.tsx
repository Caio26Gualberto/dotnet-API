                    ...
                    <div className="flex justify-center items-center h-screen px-6">
                        <div className="w-full xl:w-3/4 lg:w-11/12 flex" style={{zIndex: 2}}>
                            ...
                            <div className="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none" style={{paddingBottom: 104}}>
                                ...
                                <form className="px-8 pt-6 pb-8 mb-4 bg-white rounded" style={{marginBottom: -180}}>
                                    <div className="mb-4">
